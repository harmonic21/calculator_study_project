...
namespace s21 {
    ...
    class StringTransformer {
     ...
     private:
        ...
        static Utility::OperationType CheckUnary(const std::string& str2, Utility::OperationType type) noexcept;
        ...
        void CheckSign(std::list<EquationMember *>& list, const char *str, const std::string& str2);
