...
long double EquationMember::Sum(long double a, long double b) { return a + b; }

long double EquationMember::Sub(long double a, long double b) { return a - b; }

long double EquationMember::Mul(long double a, long double b) { return a * b; }

long double EquationMember::Del(long double a, long double b) { return a / b; }
...
long double EquationMember::Cos(long double a) { return cosl(a); }

long double EquationMember::Sin(long double a) { return sinl(a); }

long double EquationMember::Tan(long double a) { return tanl(a); }

long double EquationMember::Acos(long double a) { return acosl(a); }

long double EquationMember::Asin(long double a) { return asinl(a); }

long double EquationMember::Atan(long double a) { return atanl(a); }

long double EquationMember::Sqrt(long double a) { return sqrtl(a); }

long double EquationMember::Ln(long double a) { return logl(a); }

long double EquationMember::Log(long double a) { return log10l(a); }
...
void EquationMember::PrioritySelection() noexcept {
  ...
  if (value_type_ == Utility::kNumber || value_type_ == Utility::kX) {
    ...
    priority = 1;
  } else if (value_type_ == Utility::kUnaryPlus ||
             value_type_ == Utility::kPlus ||
             value_type_ == Utility::kUnaryMinus ||
             value_type_ == Utility::kMinus) {
    priority = 2;
  } else if (value_type_ == Utility::kMultiply ||
             value_type_ == Utility::kDivide || value_type_ == Utility::kMod) {
    priority = 3;
