...
class Utility {
 public:
  ...
  static bool IsX(const std::string &str) { return str == "x" || str == "X"; }

  static bool IsDot(const std::string &str) { return str == "."; }

  static bool IsExp(const std::string &str) { return str == "E"; }

  static bool IsLeftBracket(const std::string &str) { return str == "("; }

  static bool IsRightBracket(const std::string &str) { return str == ")"; }
 ...
 private:
  std::map<std::string, OperationType> function_ = {
      {"cos", kCos},   {"sin", kSin},   {"tan", kTan},
      {"acos", kAcos}, {"asin", kAsin}, {"atan", kAtan},
      {"ln", kLn},     {"log", kLog},   {"sqrt", kSqrt}};

  std::map<std::string, OperationType> operation_ = {
      {"+", kPlus},   {"-", kMinus}, {"*", kMultiply},
      {"/", kDivide}, {"^", kPow},   {"mod", kMod}};
};
